...
A document I must decide from --- a plan, a memo, a report of results --- is a teaching document. I read it linearly, I take every sentence at face value, and I do not think in statistical or mathematical jargon: I learned statistics on my own, never took the courses Statistics PhD students take, and have one semester of pass/fail calculus. I am comfortable with "prior," "posterior," "likelihood," and many applied terms. The more a term comes from theoretical mathematical statistics books --- "admissible," "envelope," and "epsilon-contamination" were all opaque to me --- the less it can be used without being replaced by its plain content. Prefer finite sums to integrals. The test for every passage: could I restate it to a coauthor without the file open. This is a rule about self-containment, not about level --- I rejected "treat Jake like a first-term college student" as the rule.
