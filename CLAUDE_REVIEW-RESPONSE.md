...
Instructions for Claude Code instances helping craft a response to peer reviewers. This document governs the tone, structure, and rhetorical strategy of the response memo. It supplements --- and does not override --- the writing style principles in `CLAUDE.md` and `~/.claude/CLAUDE.md`.
...
environment from the template). Number the points for easy reference.]
